...
> **关联 PRD**：[PRD-v1.2.md](../02-requirements/PRD-v1.2.md) · [architecture-v2.1.md](./architecture-v2.1.md)  
...
**裁决（PRD C11）**：数字化亮色风 = **全站视觉**；`stride-home-digital.html` = **组件与气质参考**；默认首页内容以 [PRD-v1.2 §3.2](../02-requirements/PRD-v1.2.md) 为准。

---

## 6. 角色视图可见性

与 [PRD-v1.2 §3.3](../02-requirements/PRD-v1.2.md) 一致。View Pills 切换时 **隐藏/替换** 下列模块（非仅改文案）。
